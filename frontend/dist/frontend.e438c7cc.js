...
const controlServings = function(newServings = _modelJs.state.recipe.servings) {
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"6YxfE","./config.js":"kBqbe","./views/recipeView.js":"itHCG","./views/searchView.js":"88HNW","./views/resultsView.js":"5Ax5v","./views/paginationView.js":"1WhO3","./views/bookmarksView.js":"h4SXg","./views/addRecipeView.js":"b4hZC","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"aa6765693e58a0fe":"6xMjU","a68ecfcbf29c46f6":"9A5Vw","7087588d33667af2":"2KfBB","864edee099e8affb":"k2Sud","3a3a5a2cfab86f21":"qxRHs","cff2c830bdea4f24":"kGYHC","58a74f00cee1ac64":"elQJL"}],"6YxfE":[function(require,module,exports,__globalThis) {
//& Lesson: Refactoring for MVC (Model - View - Controller)
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`loadRecipe Error \u{1F60E}: ${err}`);
        throw err;
    }
};
const loadSearchResults = async (query)=>{
    try {
        ...
        console.log(`loadSearchResults Error \u{1F60E}: ${err}`);
        throw err;
    }
};
const getSearchResultsPage = (pageNum = state.search.pageNum)=>{
...
},{"regenerator-runtime":"f6ot0","./config.js":"kBqbe","./helpers.js":"j4etx","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
},{}],"kBqbe":[function(require,module,exports,__globalThis) {
...
var _configJs = require("./config.js");
const timeout = function(s = (0, _configJs.TIMEOUT_SEC)) {
    return new Promise(function(_, reject) {
        setTimeout(function() {
            reject(new Error(`Request took too long! Timeout after ${s} second`));
        }, s * 1000);
...
},{"./config.js":"kBqbe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"itHCG":[function(require,module,exports,__globalThis) {
//& Lesson: Refactoring for MVC (Model - View - Controller)
  ...
  `;
    ...
    _generateMarkupIngredient(ing) {
        ...
        <li class="recipe__ingredient">
          ...
          <div class="recipe__quantity">${ing.quantity ? (0, _helpersJs.numberToFraction)(ing.quantity).toString() : 'some'}</div>
          <div class="recipe__description">
            <span class="recipe__unit">${ing.unit}</span>
            ${ing.description}
          </div>
...
},{"url:../../img/icons.svg":"kVUWT","../helpers.js":"j4etx","./view.js":"1NSW9","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kVUWT":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("icons.bcb921cf.svg") + "?" + Date.now();

},{}],"1NSW9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"kVUWT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"88HNW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5Ax5v":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class ResultsView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `No recipes found for your query, please try again \u{1F600}`;
    _message = '';
    _generateMarkup() {
...
},{"./view.js":"1NSW9","./previewView.js":"kzBJX","url:../../img/icons.svg":"kVUWT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kzBJX":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"1NSW9","url:../../img/icons.svg":"kVUWT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1WhO3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    `;
        ...
        if (direction === 'next') return markupNext;
        if (direction === 'prev') return markupPrev;
    };
    _generateMarkup() {
        const curPage = this._data.pageNum;
        const numPages = Math.ceil(this._data.results.length / this._data.resultsPerPage);
        // Page 1, and there are other pages
        if (curPage === 1 && numPages > 1) return this._generateMarkupBtn(curPage, 'next');
        // Last page
        if (curPage === numPages && numPages > 1) return this._generateMarkupBtn(curPage, 'prev');
        // Other page
        if (curPage < numPages) return this._generateMarkupBtn(curPage);
...
},{"./view.js":"1NSW9","url:../../img/icons.svg":"kVUWT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"h4SXg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"1NSW9","./previewView.js":"kzBJX","url:../../img/icons.svg":"kVUWT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"b4hZC":[function(require,module,exports,__globalThis) {
// import { log10 } from "core-js/core/number";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _uploadGuardJs = require("../utils/uploadGuard.js");
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerUpload(handler) {
        return (0, _uploadGuardJs.handleUploadSubmit)(handler, this._parentElement);
    }
    generateMarkup() {}
}
...
const handleUploadSubmit = function(handler, formElement) {
